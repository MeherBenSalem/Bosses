...
public class KunaiEntity extends AbstractArrow implements ItemSupplier {
	...
	public KunaiEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(RemnantOssukageModEntities.KUNAI.get(), world);
	}
	...
	public static KunaiEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		KunaiEntity entityarrow = new KunaiEntity(RemnantOssukageModEntities.KUNAI.get(), entity, world);
	...
	public static KunaiEntity shoot(LivingEntity entity, LivingEntity target) {
		KunaiEntity entityarrow = new KunaiEntity(RemnantOssukageModEntities.KUNAI.get(), entity, entity.level());
