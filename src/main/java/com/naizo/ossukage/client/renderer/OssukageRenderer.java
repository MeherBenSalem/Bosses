...
public class OssukageRenderer extends GeoEntityRenderer<OssukageEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, OssukageEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
