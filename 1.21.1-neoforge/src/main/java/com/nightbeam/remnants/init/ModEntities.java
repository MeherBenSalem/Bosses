...
public class ModEntities {
	...
	public static final DeferredHolder<EntityType<?>, EntityType<ArmoredGrubEntity>> ARMORED_GRUB = registerEntity(
			"armored_grub",
	...
	public static final DeferredHolder<Item, Item> ARMORED_GRUB_SPAWN_EGG = SPAWN_EGGS.register(
			"armored_grub_spawn_egg",
			() -> new DeferredSpawnEggItem(ARMORED_GRUB, 0x4A7C00, 0x8B5E00, new Item.Properties()));
