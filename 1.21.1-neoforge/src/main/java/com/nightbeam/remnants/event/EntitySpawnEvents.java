...
public class EntitySpawnEvents {
	...
	private static boolean isDimensionAllowed(Level level) {
		...
		// Check Whitelist
		java.util.List<String> whitelist = com.nightbeam.remnants.config.JaumlConfigLib.getStringListValue(
				"remnant/spawning",
		...
		// Check Blacklist
		java.util.List<String> blacklist = com.nightbeam.remnants.config.JaumlConfigLib.getStringListValue(
				"remnant/spawning",
