 ...
 *
 * Uses GeckoLib 4 for animated rendering.
...
public class ArmoredGrubEntity extends PathfinderMob implements GeoEntity {
    ...
    /** Required by Forge's custom client factory (spawn packet system). */
    public ArmoredGrubEntity(PlayMessages.SpawnEntity packet, Level world) {
        this(ModEntities.ARMORED_GRUB.get(), world);
    }
