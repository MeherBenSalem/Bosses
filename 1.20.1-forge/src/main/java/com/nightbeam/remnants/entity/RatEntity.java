...
public class RatEntity extends Monster {
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason,
		...
		// Apply configuration values
		double health = com.nightbeam.remnants.config.JaumlConfigLib.getNumberValue("remnant/balance", "rat_stats",
				"rat_health");
		this.getAttribute(Attributes.MAX_HEALTH).setBaseValue(health);
		this.setHealth(this.getMaxHealth());

		double armor = com.nightbeam.remnants.config.JaumlConfigLib.getNumberValue("remnant/balance", "rat_stats",
				"rat_armor");
		this.getAttribute(Attributes.ARMOR).setBaseValue(armor);

		double damage = com.nightbeam.remnants.config.JaumlConfigLib.getNumberValue("remnant/balance", "rat_stats",
				"rat_attack_damage");
