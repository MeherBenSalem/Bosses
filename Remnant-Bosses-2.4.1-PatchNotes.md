...
### Upgrade Notes
1. Replace every loader jar with 2.4.1. Both workspaces share this version.
2. Summon IDs are `remnants:ossukage`, `remnants:kotsukage`, `remnants:umbrakar`, `remnants:rat`, and so on.
...
5. Respawn Kotsukage after updating so the model without the hitbox cube loads.
