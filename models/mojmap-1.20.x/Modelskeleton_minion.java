...
public class Modelskeleton_minion<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "skeleton_minion"), "main");
	private final ModelPart root;
	private final ModelPart torso;
	private final ModelPart main_torso;
	private final ModelPart hi_head;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition main_torso = torso.addOrReplaceChild("main_torso", CubeListBuilder.create().texOffs(12, 1)
				.addBox(-4.0F, -2.0F, -3.0F, 8.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(3, 27).mirror()
				.addBox(-1.0F, -13.0F, 1.0F, 2.0F, 11.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(16, 5)
				.addBox(-4.0F, -10.0F, 1.5F, 8.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(8, 44)
				.addBox(-4.0F, -10.0F, -2.5F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(22, 26)
				...
				.addBox(2.0F, -6.0F, -1.75F, 2.0F, 2.0F, 2.4F, new CubeDeformation(0.3F)).texOffs(19, 5).addBox(-4.0F,
						-6.0F, -1.75F, 2.0F, 2.0F, 2.4F, new CubeDeformation(0.3F)),
