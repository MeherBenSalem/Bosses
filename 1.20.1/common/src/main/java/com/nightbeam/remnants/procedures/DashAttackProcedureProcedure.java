...
public class DashAttackProcedureProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		RemnantBosses.queueServerWork(60, () -> {
			if (entity instanceof RemnantOssukageEntity _datEntSetS)
		...
		if (world instanceof Level _level) {
			if (!_level.isClientSide()) {
				_level.playSound(null, BlockPos.containing(x, y, z), ModSounds.DASH_SFX.get(), SoundSource.HOSTILE, 1, 1);
			} else {
				_level.playLocalSound(x, y, z, ModSounds.DASH_SFX.get(), SoundSource.HOSTILE, 1, 1, false);
			}
		}
