...
public class OssukageSwordItem extends SwordItem {
	...
	public net.minecraft.world.InteractionResultHolder<ItemStack> use(Level level, Player player,
		...
		if (!level.isClientSide()) {
			com.nightbeam.remnants.procedures.ThrowKunaisProcedureProcedure.execute(player);

			level.playSound(null, player.blockPosition(),
					net.minecraft.core.registries.BuiltInRegistries.SOUND_EVENT
							.get(net.minecraft.resources.ResourceLocation.tryParse("entity.arrow.shoot")),
					net.minecraft.sounds.SoundSource.PLAYERS, 1f, 1f);

			player.getCooldowns().addCooldown(this,
					(int) com.nightbeam.remnants.config.JaumlConfigLib.getNumberValue("remnant/items", "ossukage_sword", "shuriken_timer"));
		}
