...
public final class JaumlConfigBootstrap {
	...
	public static void initConfigs() {
		...
		putNumber(api, "remnant/bosses", "umbrakar", "max_health", 750);
		putNumber(api, "remnant/bosses", "umbrakar", "attack_damage", 14);
		putNumber(api, "remnant/bosses", "umbrakar", "movement_speed", 0.32);
		putNumber(api, "remnant/bosses", "umbrakar", "armor", 10);
		putNumber(api, "remnant/bosses", "umbrakar", "follow_range", 48);
		putNumber(api, "remnant/bosses", "umbrakar", "hp_threshold_phase_2", 40);
		putNumber(api, "remnant/bosses", "umbrakar", "attack_damage_phase_2", 18);
		putNumber(api, "remnant/bosses", "umbrakar", "movement_speed_phase_2", 0.32);
		putNumber(api, "remnant/bosses", "umbrakar", "bite_damage", 16);
		putNumber(api, "remnant/bosses", "umbrakar", "slam_damage", 18);
		putNumber(api, "remnant/bosses", "umbrakar", "tail_damage", 15);
	...
	private static void putNumber(JaumlApi api, String path, String name, String key, Number value) {
		if (!api.arrayKeyExists(path, name, key)) {
			api.setNumberValue(path, name, key, value);
		}
	}
