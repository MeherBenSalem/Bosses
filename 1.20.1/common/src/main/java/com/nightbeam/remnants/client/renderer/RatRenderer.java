...
import com.nightbeam.remnants.client.model.animations.ratAnimation;
...
public class RatRenderer extends MobRenderer<RatEntity, Modelrat<RatEntity>> {
	public RatRenderer(EntityRendererProvider.Context context) {
		...
		this.addLayer(new RenderLayer<RatEntity, Modelrat<RatEntity>>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.tryParse("remnant_bosses:textures/entities/rat.png");
		...
		this.addLayer(new RenderLayer<RatEntity, Modelrat<RatEntity>>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.tryParse("remnant_bosses:textures/entities/rat_blue.png");
		...
		this.addLayer(new RenderLayer<RatEntity, Modelrat<RatEntity>>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.tryParse("remnant_bosses:textures/entities/rat_grey.png");
		...
		this.addLayer(new RenderLayer<RatEntity, Modelrat<RatEntity>>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.tryParse("remnant_bosses:textures/entities/rat_yellow.png");
	...
	public ResourceLocation getTextureLocation(RatEntity entity) {
		return ResourceLocation.tryParse("remnant_bosses:textures/entities/rat.png");
	}
