...
import com.nightbeam.remnants.client.model.animations.skeleton_ninjaAnimation;
...
public class RemnantOssukageRenderer extends MobRenderer<RemnantOssukageEntity, Modelskeleton_ninja<RemnantOssukageEntity>> {
	public RemnantOssukageRenderer(EntityRendererProvider.Context context) {
		...
		this.addLayer(new RenderLayer<RemnantOssukageEntity, Modelskeleton_ninja<RemnantOssukageEntity>>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.tryParse("remnant_bosses:textures/entities/ninja_dead.png");
		...
		this.addLayer(new RenderLayer<RemnantOssukageEntity, Modelskeleton_ninja<RemnantOssukageEntity>>(this) {
			final ResourceLocation LAYER_TEXTURE = ResourceLocation.tryParse("remnant_bosses:textures/entities/ninja_skeleton_orignal.png");
	...
	public ResourceLocation getTextureLocation(RemnantOssukageEntity entity) {
		return ResourceLocation.tryParse("remnant_bosses:textures/entities/ninja_dead.png");
	}
