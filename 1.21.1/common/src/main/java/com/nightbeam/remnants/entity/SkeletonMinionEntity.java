...
public class SkeletonMinionEntity extends Monster {
	public static final EntityDataAccessor<Boolean> DATA_Spawned = SynchedEntityData
			.defineId(SkeletonMinionEntity.class, EntityDataSerializers.BOOLEAN);
	...
	protected void defineSynchedData(SynchedEntityData.Builder builder) {
		...
		builder.define(DATA_Spawned, false);
	}
	...
	public void tick() {
		...
		if (this.level().isClientSide()) {
			EntityTickEvents.updateSkeletonMinionAnimations(this);
			return;
		}
		if (!statsApplied) {
			statsApplied = true;
	...
	private void setMinionAttr(net.minecraft.core.Holder<net.minecraft.world.entity.ai.attributes.Attribute> attribute, double value) {
