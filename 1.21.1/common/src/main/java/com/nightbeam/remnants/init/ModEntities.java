...
public final class ModEntities {
	...
	public static final RegistryHolder<EntityType<SkeletonMinionEntity>> SKELETON_MINION = new RegistryHolder<>(
			"skeleton_minion",
	...
	public static final RegistryHolder<EntityType<RemnantOssukageEntity>> REMNANT_OSSUKAGE = new RegistryHolder<>(
			"remnant_ossukage",
