...
public class RatEntity extends Monster {
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason,
		...
		if (this.getAttribute(Attributes.MAX_HEALTH) != null)
			this.getAttribute(Attributes.MAX_HEALTH).setBaseValue(com.nightbeam.remnants.config.JaumlConfigLib
					.getNumberValue("remnant/balance", "rat_stats", "rat_health"));
		if (this.getAttribute(Attributes.ARMOR) != null)
			this.getAttribute(Attributes.ARMOR).setBaseValue(com.nightbeam.remnants.config.JaumlConfigLib
					.getNumberValue("remnant/balance", "rat_stats", "rat_armor"));
		if (this.getAttribute(Attributes.ATTACK_DAMAGE) != null)
			this.getAttribute(Attributes.ATTACK_DAMAGE).setBaseValue(com.nightbeam.remnants.config.JaumlConfigLib
	...
	public void tick() {
		...
		if (this.level().isClientSide()) {
			EntityTickEvents.updateRatAnimations(this);
		}
	}
